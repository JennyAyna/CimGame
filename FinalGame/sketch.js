...
function setImageSize() {
    ...
    if (windowHeight <= 500 || (isMobile() && (window.orientation !== 0))) {
        triesForTarget = 20;
        return "http://s3-us-west-2.amazonaws.com/s.cdpn.io/97151/codepen-hint-300.jpg"; // 300x300
    } else {
      	triesForTarget = 15;
        return "http://s3-us-west-2.amazonaws.com/s.cdpn.io/97151/codepen-hint-500.jpg"; // 500x500
    }
}
...
Magnet.prototype.update = function() {
    ...
    this.position = p5.Vector.lerp(
        ...
        0.07 //interpolate by this amount
    );
};
